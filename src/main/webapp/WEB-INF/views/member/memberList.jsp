...
<body class="hold-transition sidebar-mini">
	...
	<form id="frm" action="${cp}/member/user">
				...
				<section class="content">
					<div class="card">
						<div class="card-header with-border">
							<button type="button" class="btn btn-primary" onclick="location.href='${cp}/member/registUser'">회원등록</button>
							
								<div id="keyword" class="card-tools" style="width: 550px;">
								<form action="${cp}/member/pagingUser">
									<div class="input-group row">
										...
										<select class="form-control col-md-3" name="searchType" id="searchType">
											...
											<button class="btn btn-primary" type="submit" id="searchBtn" data-card-widget="search" onclick="searchList_go(1);">
						...
						<div class="card-footer">
							<nav aria-label="member list Navigation">
								<ul class="pagination justify-content-center m-0">
									<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=1&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}"><i class="fas fa-angle-double-left"></i></a></li>
									<c:choose>
										<c:when test="${pageVo.page-1<1}">
											<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=${pageVo.page}&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}"><i class="fas fa-angle-left"></i></a></li>
										</c:when>
										<c:otherwise>
											<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=${pageVo.page-1}&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}"><i class="fas fa-angle-left"></i></a></li>
										</c:otherwise>
									</c:choose>
									...
									<c:forEach begin="1" end="${pagination}" var="i"> 
										<c:choose>
											...
											<c:otherwise>
												<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=${i}&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:choose>
										<c:when test="${pageVo.page+1 > pagination }">
											<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=${pageVo.page}&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}"><i class="fas fa-angle-right"></i></a></li>
										</c:when>
										<c:otherwise>
											<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=${pageVo.page+1}&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}"><i class="fas fa-angle-right"></i></a></li>																				
										</c:otherwise>
									</c:choose>
									
									<li class="page-item"><a class="page-link" href="${cp }/member/pagingUser?page=${pagination}&pageSize=${pageVo.pageSize}&searchType=${searchType}&keyword=${keyword}"><i class="fas fa-angle-double-right"></i></a></li>
								</ul>
							</nav>
