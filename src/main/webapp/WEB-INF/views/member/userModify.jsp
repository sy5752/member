...
<script>
	$(function() {
		...
		$("#cancelBtn").on("click", function() {
			...
			$("#frm").attr("method", "get");
			$("#frm").attr("action", "${cp}/member/user");
			$("#frm").submit();
		})
	})
</script>
								...
								<form id="frm" role="form" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="pass" type="password" class="form-control" id="pass" placeholder="비밀번호" value="${user.pass }"/>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="usernm" type="text" id="usernm" placeholder="이름" value="${user.usernm }" />
										</div>
									...
									<div class="form-group row">
										...
										<div class="col-sm-9 input-group-sm">
											<input class="form-control" name="alias" type="text" id="alias" placeholder="별명" value="${user.alias }">
										</div>
									</div>
									<div class="form-group row">
										<label for="addr1" class="col-sm-3 control-label">주소</label>
										<div class="col-sm-3 input-group-sm">
											<input name="addr1" type="text" class="form-control" id="addr1" placeholder="주소" readonly  value="${user.addr1 }">
										</div>
										<div class="col-sm-3 input-group-sm">
											<input name="addr2" type="text" class="form-control" id="addr2" placeholder="상세주소"  value="${user.addr2 }">	
										</div>
										
										<div class="col-sm-2 input-group-sm">
											<input name="zipcode" type="text" class="form-control" id="zipcode" placeholder="우편번호" readonly  value="${user.zipcode }">
										</div>
